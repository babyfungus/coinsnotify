# Coinsnotify
Bitcoin notification API https://www.coinsnotify.com

Coinsnotify is an alarm service(email or HTTP) when the deposit details of Bitcoin deposit are confirmed.

http://blockchain.info API has Address Gap Limits. Coinsnotify API allows you to receive more than 20 bitcoin receive notifications.
